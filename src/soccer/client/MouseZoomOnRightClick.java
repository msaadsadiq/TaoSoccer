/*
 *	@(#)MouseZoomOnRightClick.java 1.31 01/01/11 07:22:24
 *
...
/**
 * MouseZoomOnRightClick is a Java3D behavior object that lets users control the 
...
public class MouseZoomOnRightClick extends MouseBehavior {
     ...
     */
    public MouseZoomOnRightClick(TransformGroup transformGroup) {
     ...
     * @param flags
     */
    public MouseZoomOnRightClick(int flags) {
	super(flags);
    }
     ...
     * @since Java 3D 1.2.1
     */
    public MouseZoomOnRightClick(Component c) {
	super(c, 0);
    }
     ...
     * @since Java 3D 1.2.1
     */
    public MouseZoomOnRightClick(Component c, TransformGroup transformGroup) {
     ...
     * @since Java 3D 1.2.1
     */
    public MouseZoomOnRightClick(Component c, int flags) {
	super(c, flags);
    }
