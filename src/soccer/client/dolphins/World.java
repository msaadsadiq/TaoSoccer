...
public class World 
{
  ...
  public static final int DRIBBLE         = 7;
     ...
     switch (role) {
        case 0: // goalie
            if (init.clientType == InitData.LEFT) {
                ...
                offensePos = new Vector2d(-40, 0);
                defensePos = new Vector2d(-40, 0);
            } else {
                rolePos = new Vector2d(45, 0);
                offensePos = new Vector2d(40, 0);
                defensePos = new Vector2d(40, 0);
        ...
        case 1:
                ...
                if (init.clientType == InitData.LEFT) {
                    rolePos = new Vector2d(-35, -20);
                    offensePos = new Vector2d(-10, -20);
                    defensePos = new Vector2d(-25, -20);
                } else {
                    rolePos = new Vector2d(35, 20);
                    offensePos = new Vector2d(10, 20);
                    defensePos = new Vector2d(25, 20);
        ...
        case 2:
            if (init.clientType == InitData.LEFT) {
                    ...
                    offensePos = new Vector2d(-40, -5);
                    defensePos = new Vector2d(-40, -5);
                } else {
                    rolePos = new Vector2d(35, 10);
                    offensePos = new Vector2d(40, 5);
                    defensePos = new Vector2d(40, 5);
        ...
        case 6: //
                ...
                if (init.clientType == InitData.LEFT) {
                    rolePos = new Vector2d(-20, 0);
                    offensePos = new Vector2d(5, 0);
                    defensePos = new Vector2d(-10, 0);
                } else {
                    rolePos = new Vector2d(20, 0);
                    offensePos = new Vector2d(-5, 0);
                    defensePos = new Vector2d(10, 0);
        ...
        case 8: //
                ...
                if (init.clientType == InitData.LEFT) {
                    rolePos = new Vector2d(5, -15);
                    offensePos = new Vector2d(35, -10);
                    defensePos = new Vector2d(20, -10);
                } else {
                    rolePos = new Vector2d(-5, 15);
                    offensePos = new Vector2d(-35, 10);
                    defensePos = new Vector2d(-20, 10);
        ...
        case 9: //
                ...
                if (init.clientType == InitData.LEFT) {
                    rolePos = new Vector2d(5, 0);
                    offensePos = new Vector2d(25, 0);
                    defensePos = new Vector2d(15, 0);
                } else {
                    rolePos = new Vector2d(-5, 0);
                    offensePos = new Vector2d(-25, 0);
                    defensePos = new Vector2d(-15, 0);
