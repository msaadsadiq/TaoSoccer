...
public class Executor
{
  ...
  {
    this.world = world;
    this.transceiver = soccerMaster.transceiver;
    this.address = SoccerMaster.address;
    this.arena = soccerMaster.arena;
    this.port = SoccerMaster.port;
  }
  ...
  private Vector2d interceptPos()
  {
    ...
    myAcc.setX(force * Math.cos(Util.Deg2Rad(world.me.direction)) * World.K1
                                - myVel.getX() * World.K2);
                                 
    myAcc.setY(force * Math.sin(Util.Deg2Rad(world.me.direction)) * World.K1
                                - myVel.getY() * World.K2);
    double dir2Ball;
  ...
  public void executing() throws IOException
  {
    switch(world.actionType)
    {
      ...
      case World.DRIVE: drive(); break;
      case World.KICK: kick(); break;
    }
  }
